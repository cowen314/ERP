...
class ERP:
    ...
    def process_batch(subjects_directory: Path, output_directory: Path, segment_ids: List[int], segmentation_volume_rel_path: str) -> Tuple[List[str], List[str]]:
        ...
        errors = []
        results = []
        for patient_dir in self.all_patient_dirs(subjects_directory):  # TODO test generator
    ...
    def call_erp(input_dir: Path, output_dir: Path, segment_id: int) -> Tuple[str, bool]:
