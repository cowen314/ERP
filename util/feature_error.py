...
truth = Path("/home/cowen/projects/erp-data/bert-standard-processed/rawavg_features.csv")
test = Path("/home/cowen/projects/erp-data/bert-roi-processed/rawavg_features.csv")
out_f = Path("/home/cowen/projects/erp-data/manual-lhip-to-auto-lthal-comparison.csv")
truth_start_line = 86
truth_end_line = 127
test_start_line = 2
test_end_line = 43
